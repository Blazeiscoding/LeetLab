...
export const SkeletonProblemList = ({ count = 5 }: { count?: number }) => (
...
export const SkeletonCodeEditor = ({ height = "300px" }: { height?: string }) => (
  <div 
...
export const SkeletonLeaderboard = ({ rows = 5 }: { rows?: number }) => (
...
export const SkeletonSubmissionList = ({ count = 5 }: { count?: number }) => (
  <div className="space-y-3">
    {Array.from({ length: count }).map((_, i) => (
