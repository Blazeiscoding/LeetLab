...
import { MouseEvent, ReactNode, ElementType, HTMLAttributes } from "react";
...
interface MovingBorderProps extends HTMLAttributes<HTMLDivElement> {
  children: ReactNode;
  duration?: number;
  className?: string;
 ...
 */
export const TextGenerateEffect = ({ words, className = "", duration = 0.5 }: TextGenerateEffectProps) => {
 ...
 */
export const GlowingBackground = ({ className = "" }: BackgroundProps) => {
  return (
 ...
 */
export const GridBackground = ({ className = "" }: BackgroundProps) => {
  return (
    <div
