  ...
  const fetchUserData = async () => {
    try {
      ...
      if (submissionsData.length > 0) {
        console.log(
          "Sample submission problem ID:",
          submissionsData[0].problemId
        );
        console.log(
          "Sample submission problem ID type:",
          typeof submissionsData[0].problemId
        );
      }
      if (problemsData.length > 0) {
        console.log(
          "Sample problem ID:",
          problemsData[0].id || problemsData[0]._id
        );
        console.log(
          "Sample problem ID type:",
          typeof (problemsData[0].id || problemsData[0]._id)
        );
      }
