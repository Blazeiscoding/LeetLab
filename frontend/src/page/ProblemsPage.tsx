...
const ProblemCard = memo(({ problem, isSolved }: ProblemCardProps) => (
                ...
                <div className="dropdown dropdown-end">
                  ...
                  >
                    <span className="flex items-center gap-2">
                      ...
                      ) : difficultyFilter === Difficulty.MEDIUM ? (
                        <>
                  ...
                  >
                    ...
                    <li>
                      <button
                        className={`flex items-center gap-3 ${difficultyFilter === Difficulty.EASY ? "active bg-success/10 text-success" : ""}`}
                        onClick={() => {
                          setDifficultyFilter(Difficulty.EASY);
                          blurActiveElement();
                        }}
                      >
                        <span className="w-3 h-3 rounded-full bg-success"></span>
                        Easy
                        {difficultyFilter === Difficulty.EASY && <IconCircleCheck className="w-4 h-4 ml-auto text-success" />}
                      </button>
                    </li>
                    <li>
                      <button
                        className={`flex items-center gap-3 ${difficultyFilter === Difficulty.MEDIUM ? "active bg-warning/10 text-warning" : ""}`}
                        onClick={() => {
                          setDifficultyFilter(Difficulty.MEDIUM);
                          blurActiveElement();
                        }}
                      >
                        <span className="w-3 h-3 rounded-full bg-warning"></span>
                        Medium
                        {difficultyFilter === Difficulty.MEDIUM && <IconCircleCheck className="w-4 h-4 ml-auto text-warning" />}
                      </button>
                    </li>
                    <li>
                      <button
                        className={`flex items-center gap-3 ${difficultyFilter === Difficulty.HARD ? "active bg-error/10 text-error" : ""}`}
                        onClick={() => {
                          setDifficultyFilter(Difficulty.HARD);
                          blurActiveElement();
                        }}
                      >
                        <span className="w-3 h-3 rounded-full bg-error"></span>
                        Hard
                        {difficultyFilter === Difficulty.HARD && <IconCircleCheck className="w-4 h-4 ml-auto text-error" />}
                      </button>
                    </li>
                  </ul>
                </div>
