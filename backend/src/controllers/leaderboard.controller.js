...
export const getMonthlyLeaderboard = async (req, res) => {
  try {
    ...
    return res.status(200).json({
      ...
      data: {
        month: targetMonth + 1, // Convert back to 1-indexed for display
        year: targetYear,
        period: {
          start: startOfMonth,
          end: endOfMonth,
